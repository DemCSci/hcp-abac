#!/bin/bash -eu
docker-compose --compatibility -f $LOCAL_ROOT_PATH/compose/docker-compose.yaml up -d peer1.org1.lei.net peer1.web.lei.net peer1.org2.lei.net peer1.org4.lei.net peer1.org5.lei.net
