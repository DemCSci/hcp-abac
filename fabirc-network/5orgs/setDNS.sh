...
echo "127.0.0.1       org4.ifantasy.net" >> /etc/hosts
echo "127.0.0.1       org5.ifantasy.net" >> /etc/hosts
...
echo "127.0.0.1       orderer4.council.ifantasy.net" >> /etc/hosts
echo "127.0.0.1       orderer5.council.ifantasy.net" >> /etc/hosts
...
echo "127.0.0.1       peer1.org4.ifantasy.net" >> /etc/hosts
echo "127.0.0.1       peer1.org5.ifantasy.net" >> /etc/hosts