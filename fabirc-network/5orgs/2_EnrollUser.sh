...
mkdir -p $LOCAL_CA_PATH/org4.ifantasy.net/assets
cp $LOCAL_CA_PATH/org4.ifantasy.net/ca/crypto/ca-cert.pem $LOCAL_CA_PATH/org4.ifantasy.net/assets/ca-cert.pem
cp $LOCAL_CA_PATH/council.ifantasy.net/ca/crypto/ca-cert.pem $LOCAL_CA_PATH/org4.ifantasy.net/assets/tls-ca-cert.pem


mkdir -p $LOCAL_CA_PATH/org5.ifantasy.net/assets
cp $LOCAL_CA_PATH/org5.ifantasy.net/ca/crypto/ca-cert.pem $LOCAL_CA_PATH/org5.ifantasy.net/assets/ca-cert.pem
cp $LOCAL_CA_PATH/council.ifantasy.net/ca/crypto/ca-cert.pem $LOCAL_CA_PATH/org5.ifantasy.net/assets/tls-ca-cert.pem
...
# for identity
export FABRIC_CA_CLIENT_HOME=$LOCAL_CA_PATH/council.ifantasy.net/registers/orderer4
export FABRIC_CA_CLIENT_TLS_CERTFILES=$LOCAL_CA_PATH/council.ifantasy.net/assets/ca-cert.pem
export FABRIC_CA_CLIENT_MSPDIR=msp
fabric-ca-client enroll -d -u https://orderer4:orderer4@council.ifantasy.net:7050
mkdir -p $LOCAL_CA_PATH/council.ifantasy.net/registers/orderer4/msp/admincerts
cp $LOCAL_CA_PATH/council.ifantasy.net/registers/admin1/msp/signcerts/cert.pem $LOCAL_CA_PATH/council.ifantasy.net/registers/orderer4/msp/admincerts/cert.pem
# for TLS
export FABRIC_CA_CLIENT_MSPDIR=tls-msp
export FABRIC_CA_CLIENT_TLS_CERTFILES=$LOCAL_CA_PATH/council.ifantasy.net/assets/tls-ca-cert.pem
fabric-ca-client enroll -d -u https://orderer4:orderer4@council.ifantasy.net:7050 --enrollment.profile tls --csr.hosts orderer4.council.ifantasy.net
cp $LOCAL_CA_PATH/council.ifantasy.net/registers/orderer4/tls-msp/keystore/*_sk $LOCAL_CA_PATH/council.ifantasy.net/registers/orderer4/tls-msp/keystore/key.pem

echo "Enroll Orderer5"
# for identity
export FABRIC_CA_CLIENT_HOME=$LOCAL_CA_PATH/council.ifantasy.net/registers/orderer5
export FABRIC_CA_CLIENT_TLS_CERTFILES=$LOCAL_CA_PATH/council.ifantasy.net/assets/ca-cert.pem
export FABRIC_CA_CLIENT_MSPDIR=msp
fabric-ca-client enroll -d -u https://orderer5:orderer5@council.ifantasy.net:7050
mkdir -p $LOCAL_CA_PATH/council.ifantasy.net/registers/orderer5/msp/admincerts
cp $LOCAL_CA_PATH/council.ifantasy.net/registers/admin1/msp/signcerts/cert.pem $LOCAL_CA_PATH/council.ifantasy.net/registers/orderer5/msp/admincerts/cert.pem
# for TLS
export FABRIC_CA_CLIENT_MSPDIR=tls-msp
export FABRIC_CA_CLIENT_TLS_CERTFILES=$LOCAL_CA_PATH/council.ifantasy.net/assets/tls-ca-cert.pem
fabric-ca-client enroll -d -u https://orderer5:orderer5@council.ifantasy.net:7050 --enrollment.profile tls --csr.hosts orderer5.council.ifantasy.net
cp $LOCAL_CA_PATH/council.ifantasy.net/registers/orderer5/tls-msp/keystore/*_sk $LOCAL_CA_PATH/council.ifantasy.net/registers/orderer5/tls-msp/keystore/key.pem
...
echo "Start org4============================="
echo "Enroll User1"
export FABRIC_CA_CLIENT_HOME=$LOCAL_CA_PATH/org4.ifantasy.net/registers/user1
export FABRIC_CA_CLIENT_TLS_CERTFILES=$LOCAL_CA_PATH/org4.ifantasy.net/assets/ca-cert.pem
export FABRIC_CA_CLIENT_MSPDIR=msp
fabric-ca-client enroll -d -u https://user1:user1@org4.ifantasy.net:7550
mkdir -p $LOCAL_CA_PATH/org4.ifantasy.net/registers/user1/msp/admincerts

echo "Enroll Admin"
export FABRIC_CA_CLIENT_HOME=$LOCAL_CA_PATH/org4.ifantasy.net/registers/admin1
export FABRIC_CA_CLIENT_TLS_CERTFILES=$LOCAL_CA_PATH/org4.ifantasy.net/assets/ca-cert.pem
export FABRIC_CA_CLIENT_MSPDIR=msp
fabric-ca-client enroll -d -u https://admin1:admin1@org4.ifantasy.net:7550
mkdir -p $LOCAL_CA_PATH/org4.ifantasy.net/registers/admin1/msp/admincerts
cp $LOCAL_CA_PATH/org4.ifantasy.net/registers/admin1/msp/signcerts/cert.pem $LOCAL_CA_PATH/org4.ifantasy.net/registers/admin1/msp/admincerts/cert.pem

echo "Enroll Peer1"
export FABRIC_CA_CLIENT_HOME=$LOCAL_CA_PATH/org4.ifantasy.net/registers/peer1
export FABRIC_CA_CLIENT_TLS_CERTFILES=$LOCAL_CA_PATH/org4.ifantasy.net/assets/ca-cert.pem
export FABRIC_CA_CLIENT_MSPDIR=msp
fabric-ca-client enroll -d -u https://peer1:peer1@org4.ifantasy.net:7550
# for TLS
export FABRIC_CA_CLIENT_MSPDIR=tls-msp
export FABRIC_CA_CLIENT_TLS_CERTFILES=$LOCAL_CA_PATH/org4.ifantasy.net/assets/tls-ca-cert.pem
fabric-ca-client enroll -d -u https://peer1org4:peer1org4@council.ifantasy.net:7050 --enrollment.profile tls --csr.hosts peer1.org4.ifantasy.net
cp $LOCAL_CA_PATH/org4.ifantasy.net/registers/peer1/tls-msp/keystore/*_sk $LOCAL_CA_PATH/org4.ifantasy.net/registers/peer1/tls-msp/keystore/key.pem
mkdir -p $LOCAL_CA_PATH/org4.ifantasy.net/registers/peer1/msp/admincerts
cp $LOCAL_CA_PATH/org4.ifantasy.net/registers/admin1/msp/signcerts/cert.pem $LOCAL_CA_PATH/org4.ifantasy.net/registers/peer1/msp/admincerts/cert.pem

mkdir -p $LOCAL_CA_PATH/org4.ifantasy.net/msp/admincerts
mkdir -p $LOCAL_CA_PATH/org4.ifantasy.net/msp/cacerts
mkdir -p $LOCAL_CA_PATH/org4.ifantasy.net/msp/tlscacerts
mkdir -p $LOCAL_CA_PATH/org4.ifantasy.net/msp/users
cp $LOCAL_CA_PATH/org4.ifantasy.net/assets/ca-cert.pem $LOCAL_CA_PATH/org4.ifantasy.net/msp/cacerts/
cp $LOCAL_CA_PATH/org4.ifantasy.net/assets/tls-ca-cert.pem $LOCAL_CA_PATH/org4.ifantasy.net/msp/tlscacerts/
cp $LOCAL_CA_PATH/org4.ifantasy.net/registers/admin1/msp/signcerts/cert.pem $LOCAL_CA_PATH/org4.ifantasy.net/msp/admincerts/cert.pem

cp $LOCAL_ROOT_PATH/config/config-msp.yaml $LOCAL_CA_PATH/org4.ifantasy.net/msp/config.yaml
cp $LOCAL_ROOT_PATH/config/config-msp.yaml $LOCAL_CA_PATH/org4.ifantasy.net/registers/user1/msp
cp $LOCAL_ROOT_PATH/config/config-msp.yaml $LOCAL_CA_PATH/org4.ifantasy.net/registers/admin1/msp
cp $LOCAL_ROOT_PATH/config/config-msp.yaml $LOCAL_CA_PATH/org4.ifantasy.net/registers/peer1/msp
echo "End org4============================="

echo "Start org5============================="
echo "Enroll User1"
export FABRIC_CA_CLIENT_HOME=$LOCAL_CA_PATH/org5.ifantasy.net/registers/user1
export FABRIC_CA_CLIENT_TLS_CERTFILES=$LOCAL_CA_PATH/org5.ifantasy.net/assets/ca-cert.pem
export FABRIC_CA_CLIENT_MSPDIR=msp
fabric-ca-client enroll -d -u https://user1:user1@org5.ifantasy.net:7650
mkdir -p $LOCAL_CA_PATH/org5.ifantasy.net/registers/user1/msp/admincerts

echo "Enroll Admin"
export FABRIC_CA_CLIENT_HOME=$LOCAL_CA_PATH/org5.ifantasy.net/registers/admin1
export FABRIC_CA_CLIENT_TLS_CERTFILES=$LOCAL_CA_PATH/org5.ifantasy.net/assets/ca-cert.pem
export FABRIC_CA_CLIENT_MSPDIR=msp
fabric-ca-client enroll -d -u https://admin1:admin1@org5.ifantasy.net:7650
mkdir -p $LOCAL_CA_PATH/org5.ifantasy.net/registers/admin1/msp/admincerts
cp $LOCAL_CA_PATH/org5.ifantasy.net/registers/admin1/msp/signcerts/cert.pem $LOCAL_CA_PATH/org5.ifantasy.net/registers/admin1/msp/admincerts/cert.pem

echo "Enroll Peer1"
export FABRIC_CA_CLIENT_HOME=$LOCAL_CA_PATH/org5.ifantasy.net/registers/peer1
export FABRIC_CA_CLIENT_TLS_CERTFILES=$LOCAL_CA_PATH/org5.ifantasy.net/assets/ca-cert.pem
export FABRIC_CA_CLIENT_MSPDIR=msp
fabric-ca-client enroll -d -u https://peer1:peer1@org5.ifantasy.net:7650
# for TLS
export FABRIC_CA_CLIENT_MSPDIR=tls-msp
export FABRIC_CA_CLIENT_TLS_CERTFILES=$LOCAL_CA_PATH/org5.ifantasy.net/assets/tls-ca-cert.pem
fabric-ca-client enroll -d -u https://peer1org5:peer1org5@council.ifantasy.net:7050 --enrollment.profile tls --csr.hosts peer1.org5.ifantasy.net
cp $LOCAL_CA_PATH/org5.ifantasy.net/registers/peer1/tls-msp/keystore/*_sk $LOCAL_CA_PATH/org5.ifantasy.net/registers/peer1/tls-msp/keystore/key.pem
mkdir -p $LOCAL_CA_PATH/org5.ifantasy.net/registers/peer1/msp/admincerts
cp $LOCAL_CA_PATH/org5.ifantasy.net/registers/admin1/msp/signcerts/cert.pem $LOCAL_CA_PATH/org5.ifantasy.net/registers/peer1/msp/admincerts/cert.pem

mkdir -p $LOCAL_CA_PATH/org5.ifantasy.net/msp/admincerts
mkdir -p $LOCAL_CA_PATH/org5.ifantasy.net/msp/cacerts
mkdir -p $LOCAL_CA_PATH/org5.ifantasy.net/msp/tlscacerts
mkdir -p $LOCAL_CA_PATH/org5.ifantasy.net/msp/users
cp $LOCAL_CA_PATH/org5.ifantasy.net/assets/ca-cert.pem $LOCAL_CA_PATH/org5.ifantasy.net/msp/cacerts/
cp $LOCAL_CA_PATH/org5.ifantasy.net/assets/tls-ca-cert.pem $LOCAL_CA_PATH/org5.ifantasy.net/msp/tlscacerts/
cp $LOCAL_CA_PATH/org5.ifantasy.net/registers/admin1/msp/signcerts/cert.pem $LOCAL_CA_PATH/org5.ifantasy.net/msp/admincerts/cert.pem

cp $LOCAL_ROOT_PATH/config/config-msp.yaml $LOCAL_CA_PATH/org5.ifantasy.net/msp/config.yaml
cp $LOCAL_ROOT_PATH/config/config-msp.yaml $LOCAL_CA_PATH/org5.ifantasy.net/registers/user1/msp
cp $LOCAL_ROOT_PATH/config/config-msp.yaml $LOCAL_CA_PATH/org5.ifantasy.net/registers/admin1/msp
cp $LOCAL_ROOT_PATH/config/config-msp.yaml $LOCAL_CA_PATH/org5.ifantasy.net/registers/peer1/msp
echo "End org5============================="
